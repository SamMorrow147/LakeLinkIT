      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-10 lg:grid-cols-12 lg:gap-12">
          <div className="lg:col-span-5">
            ...
            >
              <RevealItem as="li" direction="up">
                <a
                  href={site.phoneHref}
                  className="group flex items-center gap-5 rounded-2xl bg-white p-5 ring-1 ring-line shadow-[var(--shadow-card)] hover:ring-leaf/50 hover:shadow-[var(--shadow-card-hover)] transition-all duration-300 hover:-translate-y-0.5"
                >
                  <Icon
                    name="phone-call"
              ...
              <RevealItem as="li" direction="up">
                <a
                  ...
                  className="group flex items-center gap-5 rounded-2xl bg-white p-5 ring-1 ring-line shadow-[var(--shadow-card)] hover:ring-lake/40 hover:shadow-[var(--shadow-card-hover)] transition-all duration-300 hover:-translate-y-0.5"
                >
                  <Icon
                    name="mail"
              ...
              <RevealItem as="li" direction="up">
                <div className="flex items-start gap-5 rounded-2xl bg-white p-5 ring-1 ring-line shadow-[var(--shadow-card)]">
                  <motion.span
                    aria-hidden
                    className="inline-flex shrink-0 text-navy"
                  ...
                  >
                    <Icon
                      name="clock"
                      className="w-10 h-10 stroke-[1.6]"
                    />
                  </motion.span>
